...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "popularCitiesDesc": "Quickly check Rahu Kaal timings for major cities or select one to set as your location.",
    "aboutGuide": "Detailed Guide",
  ...
  hi: {
    ...
    "popularCitiesDesc": "प्रमुख शहरों के लिए राहु काल का समय जल्दी से जांचें या अपना स्थान सेट करने के लिए किसी एक का चयन करें।",
    "aboutGuide": "विस्तृत गाइड",
